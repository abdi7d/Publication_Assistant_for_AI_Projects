...
class TestWebSearchTool:
    ...
    def test_web_search_connection_error(self, mock_get):
        """Test web search connection error (lines 70-73 coverage)"""
...
class TestKeywordExtractor:
    ...
    def test_keyword_extract_normal(self):
        ...
        keywords = extractor.extract("Machine learning and neural networks are AI techniques")
    ...
    def test_keyword_extract_numbers(self):
        ...
        extractor = KeywordExtractor()
        keywords = extractor.extract("Python 3.13 and TensorFlow 2.15 for AI development")
        assert isinstance(keywords, list)
